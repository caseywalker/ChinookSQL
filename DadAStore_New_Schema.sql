USE [master]
GO
/****** Object:  Database [TempData-A-Store]    Script Date: 10/27/2021 8:36:57 PM ******/
...
GO
/****** Object:  Table [dbo].[CARTDETAILS]    Script Date: 10/27/2021 8:36:57 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[CARTS]    Script Date: 10/27/2021 8:36:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CATEGORIES]    Script Date: 10/27/2021 8:36:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DEPARTMENTS]    Script Date: 10/27/2021 8:36:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ITEMS]    Script Date: 10/27/2021 8:36:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ORDERDETAILS]    Script Date: 10/27/2021 8:36:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ORDERS]    Script Date: 10/27/2021 8:36:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PAYMENTTYPES]    Script Date: 10/27/2021 8:36:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USERS]    Script Date: 10/27/2021 8:36:57 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[CARTDETAILS] ADD  DEFAULT ((0)) FOR [ItemQuantity]
GO
ALTER TABLE [dbo].[CARTDETAILS] ADD  DEFAULT ((0.0)) FOR [ItemPrice]
GO
ALTER TABLE [dbo].[CARTDETAILS] ADD  DEFAULT ((0)) FOR [Completed]
GO
ALTER TABLE [dbo].[CARTS] ADD  DEFAULT (newsequentialid()) FOR [CartID]
GO
ALTER TABLE [dbo].[CARTS] ADD  DEFAULT ('') FOR [UserID]
GO
ALTER TABLE [dbo].[CARTS] ADD  DEFAULT ((0.0)) FOR [OrderAmount]
GO
ALTER TABLE [dbo].[CARTS] ADD  DEFAULT ((0)) FOR [Completed]
GO
...
GO
ALTER TABLE [dbo].[ITEMS] ADD  DEFAULT (CONVERT([smalldatetime],getdate())) FOR [CreatedDate]
GO
...
GO
ALTER TABLE [dbo].[USERS] ADD  DEFAULT ('CUSTOMER') FOR [UserRole]
GO
ALTER TABLE [dbo].[CARTDETAILS]  WITH CHECK ADD FOREIGN KEY([CartID])
REFERENCES [dbo].[CARTS] ([CartID])
GO
ALTER TABLE [dbo].[CARTDETAILS]  WITH CHECK ADD FOREIGN KEY([ItemID])
...
GO
ALTER TABLE [dbo].[ITEMS]  WITH CHECK ADD  CONSTRAINT [FK_ITEMSSellerID] FOREIGN KEY([SellerID])
REFERENCES [dbo].[USERS] ([UserID])
GO
ALTER TABLE [dbo].[ITEMS] CHECK CONSTRAINT [FK_ITEMSSellerID]
GO
